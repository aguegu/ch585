...
static struct bt_mesh_model root_models[] = {
  ...
  BLE_MESH_MODEL(BLE_MESH_MODEL_ID_GEN_ONOFF_SRV, gen_onoff_op, &generic_onoff_srv_pub,
                 gen_onoff_srv_keys, gen_onoff_srv_groups, &generic_onoff_server),
};
